      ...
      <div className="mx-auto max-w-[1500px] px-5 md:px-10">
        ...
        <div ref={galleryRef} className="grid lg:grid-cols-12 gap-10">
          <div className="lg:col-span-7 grid grid-cols-[80px_1fr] gap-3">
            ...
            <div className="col-span-2 md:col-span-1 pd-image min-w-0">
              <Swiper
                modules={[FreeMode]}
                spaceBetween={10}
                slidesPerView={1}
          ...
          <div className="lg:col-span-5 lg:sticky lg:top-32 lg:self-start">
            <div className="pd-fade">
              ...
              <div className="mt-4 flex items-center gap-3">
                <div className="flex gap-1 text-[oklch(0.48_0.22_25)]">
                  {Array.from({ length: Math.round(p.rating) }).map((_, k) => (
              ...
              <div className="flex flex-wrap gap-2">
                {p.sizes.map((s) => (
                  <button
                    key={s}
                    onClick={() => setSize(s)}
                    className={`min-w-12 h-12 px-4 border text-grotesk text-sm tracking-[0.2em] transition ${size === s ? "bg-black text-white border-black" : "border-black/15 hover:border-black"}`}
                  >
                    {s}
                  </button>
                ))}
            ...
            <div className="pd-fade mt-8 flex items-stretch gap-3">
              ...
              <button
                ...
                className={`h-14 w-14 border border-black/15 flex items-center justify-center transition ${wished ? "text-[oklch(0.48_0.22_25)]" : ""}`}
              >
            ...
            <div className="pd-fade mt-10 grid grid-cols-3 gap-3 text-center">
              {[
                { i: FiTruck, t: "FREE OVER $250" },
                { i: FiRotateCcw, t: "30 DAY RETURNS" },
                { i: FiShield, t: "AUTHENTIC" },
              ].map(({ i: Icon, t }, k) => (
                <div key={k} className="border border-black/10 py-4">
            ...
            <div className="pd-fade mt-10 border-t border-black/10">
              <div className="flex gap-6 border-b border-black/10">
                {[
                  ...
                  <button
                    key={k}
                    onClick={() => setTab(k)}
                    className={`py-4 text-grotesk text-xs tracking-[0.3em] border-b-2 transition ${tab === k ? "border-black text-black" : "border-transparent text-[oklch(0.45_0.01_20)]"}`}
                  >
                    {l.toUpperCase()}
                  </button>
                ))}
              ...
              <div className="py-6 text-[oklch(0.25_0.01_20)] leading-relaxed text-sm">
                {tab === "desc" && (
                  <p>
                    {p.description} Hand-finished in our atelier. Each piece
                    undergoes 14-point quality control before leaving the
                    studio.
                  </p>
                )}
                {tab === "details" && (
                  <ul className="space-y-2 list-disc pl-5">
                    <li>280gsm premium fabric</li>
                    <li>Drop-shoulder construction</li>
                    <li>Embroidered house insignia</li>
                ...
                {tab === "shipping" && (
                  <ul className="space-y-2">
                    ...
                    <li>Free worldwide shipping over $250</li>
