...
function About() {
    ...
    return (
        <div ref={root} className="bone-section pt-32 md:pt-40">

            {/* HERO */}
            <section className="relative -mt-32 md:-mt-40 pt-44 md:pt-56 pb-28 overflow-hidden">
                ...
                <div className="relative mx-auto max-w-[1500px] px-5 md:px-10">
                    ...
                    <h1 className="mt-4 text-display text-6xl md:text-[9rem] leading-[0.9] text-white">
                        A church<br />of <em className="text-[oklch(0.65_0.25_27)] not-italic">cloth.</em>
                    </h1>
                    <p className="mt-8 max-w-xl text-white/70 text-lg leading-relaxed">
                        INSPIRIT was founded in 2019 in a one-room atelier in Lisbon. We don't sell trends — we ship rituals. Numbered drops. Heavy fabrics. Unisex by faith.
                    </p>
                </div>
            </section>
            ...
            <section className="py-24 md:py-32">
                <div className="mx-auto max-w-4xl px-5 md:px-10 text-center">
                    ...
                    <p className="reveal mt-8 text-display text-3xl md:text-5xl leading-tight">
                        "We design garments the way a monk copies scripture. Slowly, repeatedly, with reverence for the weight of a single seam."
                    </p>
            ...
            <section className="ink-section py-28">
                <div className="mx-auto max-w-4xl px-5 md:px-10">
                    ...
                    <div className="timeline mt-16 relative">
                        ...
                        <div
                            className="timeline-bar absolute left-4 md:left-1/2 top-0 bottom-0 w-px bg-[oklch(0.55_0.25_27)]"
                            style={{ boxShadow: '0 0 12px oklch(0.55 0.25 27)' }}
                        />
                        {[
                            ...
                            <div key={i} className={`reveal relative pl-12 md:pl-0 md:grid md:grid-cols-2 md:gap-10 mb-14 ${i % 2 ? 'md:text-left' : 'md:text-right'}`}>
                            ...
                            <div>
                                ...
                                <div className="mt-10 grid grid-cols-2 gap-5">
                                    <div className="rounded-3xl bg-white p-6 border border-black/5">
                                        ...
                                        <p className="mt-2 text-sm uppercase tracking-[0.2em] text-black/50">Push Cart</p>
                                    </div>
                                    <div className="rounded-3xl bg-white p-6 border border-black/5">
                                        <h4 className="text-4xl font-black text-[#111]">100+</h4>
                                        <p className="mt-2 text-sm uppercase tracking-[0.2em] text-black/50">Pieces Sold</p>
                                    </div>
                                </div>
                            </div>
